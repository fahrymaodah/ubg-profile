...
@section('content')
<x-breadcrumb :items="[['label' => 'Beranda', 'url' => route('home', [], false)], ['label' => 'Galeri', 'url' => route('gallery.index', [], false)], ['label' => 'Foto']]" />
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="flex gap-4 mb-8">
        ...
        <a href="{{ route('gallery.photos', [], false) }}" class="px-4 py-2 rounded-lg bg-blue-600 text-white">
            Foto
        </a>
        <a href="{{ route('gallery.videos', [], false) }}" class="px-4 py-2 rounded-lg text-gray-600 hover:bg-gray-100 transition">
            Video
        </a>
    </div>
